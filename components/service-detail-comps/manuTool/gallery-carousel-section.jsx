...
export default function GalleryCarouselSection() {
    ...
    const goNext = () => {
        pauseAutoPlay()
        const next = Math.min(activeIndex + 1, galleryImages.length - 1)
        scrollToIndex(next)
    }
                        ...
                        <div className="flex items-center justify-center gap-3" style={{ marginBottom: '20px' }}>
                            <div
                                style={{
                                    width: '40px',
                                    height: '2px',
                                    background: 'linear-gradient(90deg, transparent, #0055A4)',
                                }}
                            />
                            <span
                            ...
                            <div
                                style={{
                                    width: '40px',
                                    height: '2px',
                                    background: 'linear-gradient(90deg, #0055A4, transparent)',
                                }}
                            />
                        </div>
                    </AnimateOnScroll>
