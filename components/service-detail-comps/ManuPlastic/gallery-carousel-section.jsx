...
export default function GalleryCarouselSection() {
    ...
    const scrollToIndex = useCallback((index) => {
        ...
        const targetScroll = index * (cardW + gap)
    ...
    return (
        <>
            ...
            <section
                ...
                style={{ paddingTop: '50px', paddingBottom: '50px', background: '#FFFFFF', overflow: 'hidden' }}
            >
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...
                                        backgroundColor: 'rgba(0, 85, 164, 0.85)',
                                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                                    }}
                                >
                                    <span className="font-poppins font-semibold text-[11px] text-white">
                        ...
                        {galleryImages.map((_, index) => (
                            <button
                                ...
                                style={{
                                    ...
                                    backgroundColor: activeIndex === index ? '#0055A4' : '#CBD5E1',
            ...
            <section
                ...
                style={{ paddingTop: '80px', paddingBottom: '100px', background: '#FFFFFF', overflow: 'hidden' }}
            >
                ...
                <AnimateOnScroll animation="fadeUp" delay={200}>
                    <div style={{ position: 'relative', marginTop: '50px' }}>
                        ...
                        <button
                            ...
                            style={{
                                position: 'absolute', left: '32px', top: '50%', transform: 'translateY(-50%)', zIndex: 20,
                                width: '52px', height: '52px', borderRadius: '50%',
                                backgroundColor: activeIndex === 0 ? 'rgba(255,255,255,0.5)' : 'rgba(0, 85, 164, 0.9)',
                                border: activeIndex === 0 ? '1px solid #CBD5E1' : 'none',
                                cursor: activeIndex === 0 ? 'default' : 'pointer',
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                boxShadow: activeIndex === 0 ? 'none' : '0 4px 20px rgba(0, 85, 164, 0.3)',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={activeIndex === 0 ? '#94A3B8' : 'white'} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <button
                            ...
                            style={{
                                position: 'absolute', right: '32px', top: '50%', transform: 'translateY(-50%)', zIndex: 20,
                                width: '52px', height: '52px', borderRadius: '50%',
                                backgroundColor: activeIndex === galleryImages.length - 1 ? 'rgba(255,255,255,0.5)' : 'rgba(0, 85, 164, 0.9)',
                                border: activeIndex === galleryImages.length - 1 ? '1px solid #CBD5E1' : 'none',
                                cursor: activeIndex === galleryImages.length - 1 ? 'default' : 'pointer',
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                boxShadow: activeIndex === galleryImages.length - 1 ? 'none' : '0 4px 20px rgba(0, 85, 164, 0.3)',
                                transition: 'all 0.3s ease',
                            }}
                        >
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={activeIndex === galleryImages.length - 1 ? '#94A3B8' : 'white'} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div
                            ...
                            onMouseLeave={handleMouseUp}
                            style={{
                                display: 'flex', gap: `${DESKTOP_GAP}px`, overflowX: 'auto',
                                scrollSnapType: 'x mandatory', scrollbarWidth: 'none', msOverflowStyle: 'none',
                                paddingLeft: 'calc(50% - 210px)', paddingRight: 'calc(50% - 210px)',
                        ...
                        >
                            {galleryImages.map((img, index) => (
                                <div
                                    key={index}
                                    style={{
                                        flex: `0 0 ${DESKTOP_CARD_W}px`, height: '280px', borderRadius: '20px',
                                        overflow: 'hidden', position: 'relative', scrollSnapAlign: 'center',
                                        transition: 'transform 0.4s ease, box-shadow 0.4s ease',
                                        transform: activeIndex === index ? 'scale(1.03)' : 'scale(0.95)',
                                        opacity: activeIndex === index ? 1 : 0.6,
                                        boxShadow: activeIndex === index
                                            ? '0 12px 40px rgba(0, 85, 164, 0.25)'
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        background: 'linear-gradient(to top, rgba(0,0,0,0.7) 0%, transparent 100%)',
                                        opacity: activeIndex === index ? 1 : 0.5, transition: 'opacity 0.4s ease',
                                    }} />
                                    <div style={{
