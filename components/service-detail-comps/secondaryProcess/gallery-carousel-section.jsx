...
export default function GalleryCarouselSection() {
    ...
    const goNext = () => { pauseAutoPlay(); scrollToIndex(Math.min(activeIndex + 1, galleryImages.length - 1)) }
                    ...
                    >
                        {galleryImages.map((img, index) => (
                            <div
                                key={index}
                                style={{
                                    flex: `0 0 ${MOBILE_CARD_W}px`, height: '220px', borderRadius: '16px',
                    ...
                    <div style={{ position: 'relative', marginTop: '50px' }}>
                        ...
                        <button onClick={goPrev} disabled={activeIndex === 0}
                            style={{
                                ...
                                boxShadow: activeIndex === 0 ? 'none' : '0 4px 20px rgba(0, 85, 164, 0.3)', transition: 'all 0.3s ease',
                            }}
                        >
                        ...
                        {/* Right arrow */}
                        <button onClick={goNext} disabled={activeIndex === galleryImages.length - 1}
                            style={{
                                ...
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                boxShadow: activeIndex === galleryImages.length - 1 ? 'none' : '0 4px 20px rgba(0, 85, 164, 0.3)', transition: 'all 0.3s ease',
                            }}
                        >
